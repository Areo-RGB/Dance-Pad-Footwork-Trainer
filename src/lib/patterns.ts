...
export const DRILL_PATTERNS: PatternDef[] = [
  ...
  { id: "toe_pivot_right", title: "Toe Pivot — Right", subtitle: "R heel anchors, toe sweeps to 90° external and back", theme: "orientation", frames: parseFrames([{ L:4, R:6, Ld:'↑', Rd:'↑' },{ L:4, R:6, Ld:'↑', Rd:'↗' },{ L:4, R:6, Ld:'↑', Rd:'→' },{ L:4, R:6, Ld:'↑', Rd:'↗' },{ L:4, R:6, Ld:'↑', Rd:'↑' }]) },
  { id: "toe_pivot_left", title: "Toe Pivot — Left", subtitle: "L heel anchors, toe sweeps to 90° external and back", theme: "orientation", frames: parseFrames([{ L:4, R:6, Ld:'↑', Rd:'↑' },{ L:4, R:6, Ld:'↖', Rd:'↑' },{ L:4, R:6, Ld:'←', Rd:'↑' },{ L:4, R:6, Ld:'↖', Rd:'↑' },{ L:4, R:6, Ld:'↑', Rd:'↑' }]) },
